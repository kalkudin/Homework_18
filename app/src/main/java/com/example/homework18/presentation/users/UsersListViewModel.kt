...
class UsersListViewModel @Inject constructor (private val usersListRepository: UsersListRepository): ViewModel() {
    private val _usersFlow = MutableStateFlow<Resource<List<UsersList>>?>(null)
    val usersFlow : StateFlow<Resource<List<UsersList>>?> = _usersFlow.asStateFlow()
